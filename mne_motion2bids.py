...
info = mne.create_info(ch_names=test_motion_data.channels.name, sfreq=test_motion_data.info.SamplingFrequency, ch_types='bio')
raw = mne.io.RawArray(test_motion_data.time_series, info)

# write to BIDS
bids_path = BIDSPath(subject=test_motion_data.info.SubjectId, task=test_motion_data.info.TaskName, datatype='beh', root=bids_root)
